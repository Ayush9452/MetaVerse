...
describe("Authentication", () => {
    test('User is able to sign up only once', async () => {
        const username = "tempTest" + Math.random(); // kirat0.12331313
    ...
    test('Signup request fails if the username is empty', async () => {
        const username = `tempTest-${Math.random()}` // tempTest-0.12312313
        const password = "123456"
    ...
    test('Signin succeeds if the username and password are correct', async() => {
        const username = `tempTest-${Math.random()}`
        const password = "123456"
...
describe("User avatar information", () => {
    ...
    test("Available avatars lists the recently created avatar", async () => {
        ...
        const currentAvatar = response.data.avatars.find(x => x.avatarId === avatarId);
...
describe("Space information", () => {
    ...
    test("Admin has gets once space after", async () => {
        ...
        const filteredSpace = response.data.spaces.find(x => x.spaceId === spaceCreateReponse.data.spaceId)
...
describe("Arena endpoints", () => {
    ...
    beforeAll(async () => {
        ...
        console.log("new space response is " + JSON.stringify(spaceResponse.data))
    ...
    test("Delete endpoint is able to delete an element", async () => {
        ...
        console.log("after delete response is " + newResponse.data.elements.length)
